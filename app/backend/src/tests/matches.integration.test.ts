...
describe('Testes de integração da rota /matches', async () => {
  ...
  it('A rota /matches?inProgress=true deve retornar todos as partidas cadastradas de acordo com o filtro', async () => {
    sinon.stub(MatchModel, 'findAll').resolves(matchesMock as unknown as MatchModel[]);
  ...
  it('A rota /matches?inProgress=false deve retornar todos as partidas cadastradas de acordo com o filtro', async () => {
    sinon.stub(MatchModel, 'findAll').resolves(matchesMock as unknown as MatchModel[]);
